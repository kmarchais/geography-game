...
describeOrSkip('Paris Arrondissements Game Configuration', () => {
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('paris-arrondissements')
    expect(gameConfig.name).toBe('Paris Arrondissements')
