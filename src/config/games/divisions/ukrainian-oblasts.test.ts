...
import gameConfigJson from './ukrainian-oblasts.json'
...
describeOrSkip('Ukrainian Oblasts Game Configuration', () => {
  ...
  it('should have exactly 25 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(25)
  })

  it('should have 25 total features', () => {
    expect(processedData.features).toHaveLength(25)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('ukrainian-oblasts')
    expect(gameConfig.name).toBe('Ukrainian Oblasts')
