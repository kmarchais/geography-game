...
import gameConfigJson from './chinese-provinces.json'
...
describeOrSkip('Chinese Provinces Game Configuration', () => {
  ...
  it('should have exactly 34 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(34)
  })

  it('should have 34 total features', () => {
    expect(processedData.features).toHaveLength(34)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('chinese-provinces')
    expect(gameConfig.name).toBe('Chinese Provinces')
