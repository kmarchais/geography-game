...
import gameConfigJson from './belgian-provinces.json'
...
describeOrSkip('Belgian Provinces Game Configuration', () => {
  ...
  beforeAll(async () => {
    ...
    // Extract filename from URL (e.g., /geography-game/data/file.json -> file.json)
