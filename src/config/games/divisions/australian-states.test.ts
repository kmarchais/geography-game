...
import gameConfigJson from './australian-states.json'
...
describeOrSkip('Australian States & Territories Game Configuration', () => {
  ...
  it('should have exactly 9 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(9)
  })

  it('should have 9 total features', () => {
    expect(processedData.features).toHaveLength(9)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('australian-states')
    expect(gameConfig.name).toBe('Australian States & Territories')
