...
import gameConfigJson from './us-states.json'
...
describeOrSkip('US States Game Configuration', () => {
  ...
  it('should have exactly 51 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(51)
  })

  it('should have 51 total features', () => {
    expect(processedData.features).toHaveLength(51)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('us-states')
    expect(gameConfig.name).toBe('US States')
