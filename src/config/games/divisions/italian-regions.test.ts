...
import gameConfigJson from './italian-regions.json'
...
describeOrSkip('Italian Regions Game Configuration', () => {
  ...
  it('should have exactly 20 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(20)
  })

  it('should have 20 total features', () => {
    expect(processedData.features).toHaveLength(20)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('italian-regions')
    expect(gameConfig.name).toBe('Italian Regions')
