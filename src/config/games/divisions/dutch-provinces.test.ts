...
import gameConfigJson from './dutch-provinces.json'
...
describeOrSkip('Dutch Provinces Game Configuration', () => {
  ...
  it('should have exactly 12 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(12)
  })

  it('should have 12 total features', () => {
    expect(processedData.features).toHaveLength(12)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('dutch-provinces')
    expect(gameConfig.name).toBe('Dutch Provinces')
