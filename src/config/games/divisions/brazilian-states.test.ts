...
import gameConfigJson from './brazilian-states.json'
...
describeOrSkip('Brazilian States Game Configuration', () => {
  ...
  it('should have exactly 27 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(27)
  })

  it('should have 27 total features', () => {
    expect(processedData.features).toHaveLength(27)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('brazilian-states')
    expect(gameConfig.name).toBe('Brazilian States')
