...
import gameConfigJson from './africa.json'
...
describeOrSkip('African Countries Game Configuration', () => {
  ...
  it('should have exactly 54 unique territories', () => {
    ...
    expect(uniqueEntities).toHaveLength(54)
  })

  it('should have 54 total features', () => {
    expect(processedData.features).toHaveLength(54)
  })
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('africa-countries')
    expect(gameConfig.name).toBe('African Countries')
