...
import gameConfigJson from './asia.json'
...
describeOrSkip('Asian Countries Game Configuration', () => {
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('asia-countries')
    expect(gameConfig.name).toBe('Asian Countries')
