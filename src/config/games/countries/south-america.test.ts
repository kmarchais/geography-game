...
import gameConfigJson from './south-america.json'
...
describe('South American Countries Game Configuration', () => {
  ...
  it('should have correct game metadata', () => {
    expect(gameConfig.id).toBe('south-america-countries')
    expect(gameConfig.name).toBe('South American Countries')
