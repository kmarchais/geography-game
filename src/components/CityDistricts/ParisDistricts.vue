<template>
  <MapGame
    ...
    :process-geojson-data-fn="processParisDistrictsData"
  />
</template>
...
import { parisDistrictsConfig } from "../../utils/cityDistrictsConfig";
import type { GeoJSONProperties } from "../../utils/geojsonUtils";

const config = parisDistrictsConfig;
...
const processParisDistrictsData = (
  ...
  console.log(`Loaded ${processedFeatures.length} Paris districts`);
